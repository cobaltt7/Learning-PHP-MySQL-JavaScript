...
<br>I made two arrays that, instead of using numbers to define the nth items, it uses words! For both of them, I used one of PHP's built-in functions to print them all out.
