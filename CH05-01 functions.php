<?php
$design['title']       = 'LPMJ Book - functions';
$design['description'] = ' functions activity from the book Learning PHP, MySQL & JavaScript with jQuery, CSS & HTML5 by Robin Nixon';
$design['keywords']    = " functions, mouse, over, built-in, hello, world, hip, hooray, upper, lower, case, lowercase, uppercase, randomcase, random, convert, name, william, henry, gates, book, learning php mysql javascript with jquery css html5, robin nixon, activities, learning, php, mysql, javascript, jquery, css, html, html5, robin, nixon, O'Reilly, LPMJ";
$design['LEFT']        = <<<_END
...
<br>With this code, I experimented with predifined functions, nested functions, and custom functions.
<br>See what it evaluates to over there 👉!
<br>Mouse over each word to see what function I used.
_END;
...
<h1>My own functions:</h1><span title='Mine: Fix names, return full name | via nested: Capatalize first letter/Convert to lowercase'>" . fixNames1("WILLIAM", "HEnry", "gates") . " </span>
...
$design['RIGHT'] .= "<h1>With no functions</h1><i>Before the functions, there was:</i>
