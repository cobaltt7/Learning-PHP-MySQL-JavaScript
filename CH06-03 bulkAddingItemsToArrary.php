...
<br>I made two arrays, but unlike the previous examples where I added ech item one-by-one, I added all of the items to the array at once! For both of them, I used one of PHP's built-in functions to print them all out.
